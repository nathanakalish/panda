...
```
python -m panda.examples.can_logger
...
```
$ python -m panda.examples.can_unique door-fl-1.csv background*
...
$ python -m panda.examples.can_unique door-fl-2.csv background*
